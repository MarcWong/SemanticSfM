...
#include "i23dSFM_Samples/robust_essential_spherical/spherical_cam.hpp"
...
int main() {
  ...
  // Essential geometry filtering of putative matches
  {
    ...
    //-- Essential matrix robust estimation from spherical bearing vectors
    {
      ...
      typedef i23dSFM::spherical_cam::EssentialKernel_spherical Kernel;

      // Define the AContrario angular error adaptor
      typedef i23dSFM::robust::ACKernelAdaptor_AngularRadianError<
          i23dSFM::spherical_cam::EightPointRelativePoseSolver,
          i23dSFM::spherical_cam::AngularError,
          Mat3>
          KernelType;
      ...
      if (vec_inliers.size() > 120)
      {
        ...
        for (int kk = 0; kk < 4; ++kk) {
          ...
          for (size_t k = 0; k < vec_inliers.size(); ++k)
          {
            ...
            //Triangulate
            Vec3 X;
            i23dSFM::spherical_cam::TriangulateDLT(P1, x1_, P2, x2_, &X);
