...
public:
  ...
  (
    const i23dSFM::sfm::SfM_Data * sfm_data,
    QWidget *parent = nullptr
  );

  /// Update control points X,Y,Z data (if valid datum is provided)
  void update_control_points(i23dSFM::sfm::Landmarks & control_points);
